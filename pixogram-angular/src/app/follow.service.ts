...
const myfollowers='http://localhost:9085/follow/myfollowers';
const httpOptions={
...
getmyfollowers(username):Observable<any>{
  return this.http.get(myfollowers + "/" + username).pipe(map(this.extractData));
}
